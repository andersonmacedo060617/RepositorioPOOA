 ...
 */
@Entity
@Table(name = "aluno_turma", catalog = "academico", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "AlunoTurma.findByAlunoTurmacol", query = "SELECT a FROM AlunoTurma a WHERE a.alunoTurmacol = :alunoTurmacol")})
public class AlunoTurma implements Serializable {
    ...
    @Column(name = "aluno_turmacol", length = 45)
    private String alunoTurmacol;
    ...
    public String getAlunoTurmacol() {
        return alunoTurmacol;
    }

    public void setAlunoTurmacol(String alunoTurmacol) {
        this.alunoTurmacol = alunoTurmacol;
    }
